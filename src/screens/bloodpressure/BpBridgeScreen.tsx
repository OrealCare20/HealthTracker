...
const BpBridgeScreen = ({navigation}: {navigation: any}) => {
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.heading}>{language.dashobard.bp}</Text>
      </View>
      <Image
        style={styles.bannerImg}
        source={require('../../assets/images/dashboard_icons_new/bp_static.png')}
      />
